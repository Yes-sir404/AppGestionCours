...
public:
    ...
    QRadioButton *radioEtudiant;
    QRadioButton *radioProf;
    ...
    void setupUi(QDialog *SignupDialog)
    {
        ...
        radioEtudiant = new QRadioButton(SignupDialog);
        radioEtudiant->setObjectName("radioEtudiant");
        radioEtudiant->setChecked(true);

        verticalLayout->addWidget(radioEtudiant);

        radioProf = new QRadioButton(SignupDialog);
        radioProf->setObjectName("radioProf");

        verticalLayout->addWidget(radioProf);
    ...
    void retranslateUi(QDialog *SignupDialog)
    {
        ...
        radioEtudiant->setText(QCoreApplication::translate("SignupDialog", "Etudiant", nullptr));
        radioProf->setText(QCoreApplication::translate("SignupDialog", "Professeur", nullptr));
